...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    _arr_squareFeet = [[NSArray alloc] initWithObjects:@"27,802", @"27,957", @"28,112", @"28,276", @"28,433", @"28,591", @"28,337 ", @"28,439", @"28,694", @"28,853", @"29,002", @"29,161", @"29,161", @"29,750", @"45,571", @"45,571", nil];
